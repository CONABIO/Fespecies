            ...
            <div class="flex items-center justify-between gap-6 mb-12">
                ...
                <div class="flex-1 max-w-3xl w-full" @click.away="showResults = false">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" x-model="query" @input.debounce.400ms="buscarCatalogo()"
                        ...
                        <div x-show="showResults" x-cloak x-transition
                            ...
                            <template x-for="item in results" :key="item.especieId">
                                <div @click="seleccionar(item.taxon)"
                                    ...
                                    <div class="flex flex-col text-left">
                                        <span class="text-slate-900 font-bold text-lg italic group-hover:text-indigo-600" x-text="item.taxon"></span>
                                        <span class="text-slate-400 text-xs font-semibold tracking-widest" x-text="item.AutorTaxon"></span>
                                    </div>
                                </div>
                            </template>
                        </div>
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-100">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="bg-white">
                                ...
                                <tr @click="selectedId = (selectedId === {{ $taxon->especieId }} ? null : {{ $taxon->especieId }})"
                                    ...
                                    <td class="p-2 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="/editar-ficha/{{ $taxon->especieId }}"
                                               class="w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center transition-all shadow-md"
                                               title="Editar">
                                            ...
                                            <button type="button"
                                                    class="w-10 h-10 rounded-full bg-red-500 hover:bg-red-600 text-white flex items-center justify-center transition-all shadow-md"
                                                    title="Eliminar">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="p-12 text-center text-gray-400 italic bg-slate-50">
